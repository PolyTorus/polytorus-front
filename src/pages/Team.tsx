...
import { Code, Server, Layout, User, Github, Linkedin, XIcon } from "lucide-react";
  ...
  const teamData: TeamData[] = [
    {
      name: "ブロックチェーン・暗号研究",
      icon: Code,
      description: "最先端の暗号技術とブロックチェーンプロトコルの研究開発を行うチームです。",
      members: [
        {
          name: "Hiro Nakanishi",
          role: "Owner",
    ...
    },
    {
      name: "バックエンド",
      icon: Server,
      description: "高性能で安全なバックエンドシステムの設計と実装を担当するチームです。",
      members: [
        {
          name: "Bob Johnson",
          role: "シニアバックエンドエンジニア",
    ...
    },
    {
      name: "フロントエンド",
      icon: Layout,
      description: "ユーザーフレンドリーで直感的なインターフェースの開発を行うチームです。",
      members: [
        {
          name: "Charlie Brown",
      ...
      >
        ...
        >
          <VStack align="start" p={4}>
            ...
            <HStack>
              <Link href={`https://github.com/${member.githubUsername}`} isExternal>
                <Icon as={Github} />
              </Link>
              {member.linkedinUrl && (
    ...
    return (
      <Box bg={useColorModeValue("gray.50", "gray.900")}>
        <Container maxW="6xl" py={20}>
          <VStack p={16}>
            <Heading as="h1" size="2xl" textAlign="center">Our Team</Heading>
            <Text fontSize="xl" textAlign="center" maxW="3xl">
                We are a diverse group of experts dedicated to building the future of quantum-resistant blockchain technology.
                Our team combines deep knowledge in cryptography, distributed systems, and user experience design.
            </Text>
            {teamData.map((team) => (
